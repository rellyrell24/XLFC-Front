...
export const CoachHomepageOne = () => {
    return (
        <div className="coach-homepage-one">
            <div className="overlap-wrapper">
                <div className="overlap">
                    ...
                    <div className="text-wrapper-3">Choose your team</div>
                    <div className="frame-3">
                        <div className="frame-4">
                            <div className="text-wrapper-4">XLFC Readings</div>
                        ...
                        <div className="frame-6">
                            <div className="text-wrapper-5">Total Points:</div>
                            <div className="text-wrapper-6">953</div>
                        </div>
                        <div className="overlap-2">
                            <img className="group" alt="Group" src="group-1532.png" />
                            <div className="layer-wrapper">
                                <img className="layer-2" alt="Layer" src="image.png" />
                            </div>
                        </div>
                    </div>
