...
export const DifferentTeams = () => {
    return (
        <div className="different-teams">
            <div className="overlap-wrapper">
                <div className="overlap">
                    <img className="img" alt="Img" src="62ed26e70a7ec30939dc5e5f-BG-blur-light-1-2.png" />
                    <div className="frame">
                        <div className="sarah-collin">Search for a season</div>
                        <img className="loupe" alt="Loupe" src="loupe-1.svg" />
                    </div>
                    <img className="frame-2" alt="Frame" src="frame-62.svg" />
                    <div className="fill-your-profile">Pick a season</div>
                    ...
                    <div className="frame-6">
                        ...
                        <div className="my-recepits">
                            ...
                            <div className="text-wrapper-2">Weigh in</div>
                        </div>
                        ...
                        <div className="message">
                            ...
                            <div className="text-wrapper-3">player stats</div>
                        </div>
                        <div className="setting">
                            <img className="setting-2" alt="Setting" src="setting.svg" />
                            <div className="text-wrapper-4">Past Seasons</div>
                        </div>
